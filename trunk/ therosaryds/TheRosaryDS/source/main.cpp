...
#include <sstream>	//Include for string support
...
void RunCredits()
{
	...
	credits[0] = "The RosaryDS v1.3.2.0";
	credits[1] = "";
...
void DisplayMystery(int indexOfFive)
{
	...
	if(daynum == 0 || daynum == 3)
	{
		...
		case 1:
			...
			else
			{
				//Wed...
				PA_EasyBgLoad(1, 2, RosaryTopMix);
				PA_OutputSimpleText(1,0,12, txtGloriousWed1_1.data());
				PA_WaitFor((PA_SpriteTouched(1)) || (Pad.Newpress.A));//Next pressed
				PA_EasyBgLoad(1, 2, RosaryTopMix);
				PA_OutputSimpleText(1,0,12, txtGloriousWed1_2.data());
				PA_WaitFor((PA_SpriteTouched(1)) || (Pad.Newpress.A));//Next pressed
				PA_EasyBgLoad(1, 2, RosaryTopMix);
				PA_OutputSimpleText(1,0,12, txtGloriousWed1_3.data());
				PA_EasyBgLoad(1, 2, RosaryTopMix);
				PA_OutputSimpleText(1,0,12, txtGloriousWed1_4.data());
				PA_WaitFor((PA_SpriteTouched(1)) || (Pad.Newpress.A));//Next pressed
				PA_EasyBgLoad(1, 2, RosaryTopMix);
				PA_OutputSimpleText(1,0,12, txtGloriousWed1_5.data());
				PA_WaitFor((PA_SpriteTouched(1)) || (Pad.Newpress.A));//Next pressed
				PA_EasyBgLoad(1, 2, RosaryTopMix);
				PA_OutputSimpleText(1,0,12, txtGloriousWed1_6.data());
				PA_WaitFor((PA_SpriteTouched(1)) || (Pad.Newpress.A));//Next pressed
				PA_EasyBgLoad(1, 2, RosaryTopMix);
				PA_InitCustomText(1, 0, newfont);
				PA_OutputSimpleText(1,0,12, txtGloriousWed1_7.data());
			}
	...
	if(daynum == 4)
	{
		...
		case 1:
			//...
			PA_EasyBgLoad(1, 2, RosaryTopMix);
			PA_OutputSimpleText(1,0,12, txtLight1_1.data());
			FinishedReading = true;
			break;
		case 2:
			PA_EasyBgLoad(0, 2, RosaryBottomMix);
	...
	if(daynum == 2 || daynum == 5)
	{
		...
		case 1:
			//Matthew 26:36-46...
			PA_EasyBgLoad(1, 2, RosaryTopMix);
			PA_OutputSimpleText(1,0,12, txtSorrowful1_1.data());
			PA_WaitFor((PA_SpriteTouched(1)) || (Pad.Newpress.A));//Next pressed
			PA_EasyBgLoad(1, 2, RosaryTopMix);
			PA_OutputSimpleText(1,0,12, txtSorrowful1_2.data());
			PA_WaitFor((PA_SpriteTouched(1)) || (Pad.Newpress.A));//Next pressed
			PA_EasyBgLoad(1, 2, RosaryTopMix);
			PA_OutputSimpleText(1,0,12, txtSorrowful1_3.data());
			PA_EasyBgLoad(1, 2, RosaryTopMix);
			PA_InitCustomText(1, 0, newfont);
			PA_OutputSimpleText(1,0,12, txtSorrowful1_4.data());
			break;
		case 2:
			if(daynum == 2)
			{
